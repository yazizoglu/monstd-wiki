...
|---|---|
| Base HP | 160 |
| Speed | High (65 — near goblin speed) |
| Armor | Minimal (8%) |
| Resistances | None |
| Kill Reward | 12 gold |
...
- **Regenerating** — Heals 2% of max HP per second. Poison damage deals 50% bonus damage against regenerating enemies.
...
- Poison Tower hard-counters regeneration with 50% bonus damage
- Light armor — not resistant to elemental damage
- High speed makes Frost Tower slow very impactful
...
| Tower | Reason |
|---|---|
| [[Poison Tower]] | 50% bonus damage against regenerating enemies; DoT prevents out-healed hits |
| [[Frost Tower]] | Slows Gnolls enough for other towers to focus |
| [[Arrow Tower]] | High fire rate keeps regeneration from outpacing damage |
