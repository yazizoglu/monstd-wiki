...
Enemies travel along fixed paths toward your base. Each enemy type has unique stats, resistances, and behaviors designed to pressure specific tower builds.

---

## Enemy Roster

| Enemy | HP | Speed | Key Traits | Maps |
|---|---|---|---|---|
...
| Trait | Effect |
|---|---|
| **Flying** | Only Arrow Tower and Lightning Tower can target |
| **Armor Plated** | Physical −35%; Lightning +35% |
| **Regenerating** | Heals 2% max HP/sec; Poison +50% |
